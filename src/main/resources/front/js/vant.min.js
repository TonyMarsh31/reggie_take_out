  ...
  return (function (t) {
    ...
    function (t, e, i) {
      ...
      t.exports = function (t) {
        return t.reduce(function (t, e) {
          for (var i in e)
            if (t[i])
              if (-1 !== r.indexOf(i)) t[i] = n({}, t[i], e[i]);
              else if (-1 !== s.indexOf(i)) {
    ...
    function (t, e, i) {
            ...
            (("body" !== c(e) || d(h)) &&
              (m =
                (n = e) !== s(n) && l(n)
                  ...
                  : o(n)),
            l(e)
              ? (((v = r(e)).x += e.clientLeft), (v.y += e.clientTop))
              : h &&
                (v.x = (function (t) {
      ...
      function p(t) {
        return "html" === c(t)
          ? t
          : t.assignedSlot || t.parentNode || t.host || u(t);
      }
      function m(t, e) {
        void 0 === e && (e = []);
        var i = (function t(e) {
          ...
          n = "body" === c(i),
          r = s(i),
          o = n ? [r].concat(r.visualViewport || [], d(i) ? i : []) : i,
          a = e.concat(o);
      ...
      function b(t) {
        for (var e = s(t), i = g(t); i && v(i) && "static" === h(i).position; )
          i = g(i);
        return i && "body" === c(i) && "static" === h(i).position
          ? e
          : i ||
              (function (t) {
                for (
                  var e = p(t);
                  l(e) && ["html", "body"].indexOf(c(e)) < 0;
      ...
      var y = "top",
        S = "right",
        k = "left",
        x = [].concat([y, "bottom", S, k], ["auto"]).reduce(function (t, e) {
          ...
          var s,
            ...
            d = {
              ...
              setOptions: function (i) {
                ...
                return (
                  (c.orderedModifiers = s.filter(function (t) {
                    return t.enabled;
                  })),
                  ...
                  if ($(e, i)) {
                    ...
                    for (var s = 0; s < c.orderedModifiers.length; s++)
                      if (!0 !== c.reset) {
                        ...
                        "function" == typeof a &&
                          (c =
                            a({ state: c, options: u, name: p, instance: d }) ||
                            c);
                      } else (c.reset = !1), (s = -1);
                  }
                }
      ...
      function E(t) {
        ...
        if (h) {
          ...
          C === s(i) && (C = u(i)),
            o === y &&
              ((x = "bottom"),
              (p -= C.clientHeight - r.height),
              (p *= c ? 1 : -1)),
            o === k &&
              ((g = S), (f -= C.clientWidth - r.width), (f *= c ? 1 : -1));
        }
        var O,
          T = n({ position: l }, h && D);
        return n(
        ...
        defaultModifiers: [
          {
            ...
            effect: function (t) {
              ...
              return (
                ...
                l && c.addEventListener("resize", i.update, I),
                function () {
                  o &&
                    u.forEach(function (t) {
          ...
          },
          {
            ...
            effect: function (t) {
              ...
              return (
                n(e.elements.popper.style, i.popper),
              ...
              return (
                (t[i] = (function (t, e, i) {
                  ...
                  return (
                    (a = a || 0),
                    (l = (l || 0) * s),
                    [k, S].indexOf(r) >= 0 ? { x: l, y: a } : { x: a, y: l }
                  );
                })(i, e.rects, o)),
                t
              );
    ...
    function (t, e, i) {
      ...
      function h(t) {
        ...
        return function (t) {
          for (
            var i = u.a.messages(),
              n = Object(r.a)(i, e + t) || Object(r.a)(i, t),
              s = arguments.length,
    ...
    function (t, e, i) {
      ...
      t.exports = (function () {
        ...
        function e(e, r) {
          for (var s in (f(e, r), r))
            if ("__proto__" !== s && n(r, s)) {
              var o = r[s];
              i(o)
                ? ("undefined" === m(e[s]) && "function" === m(o) && (e[s] = o),
                  (e[s] = t(e[s] || {}, o)))
                : (e[s] = o);
            }
          return e;
              ...
              return (
                h(e, [
                  ...
                  },
                  {
                    ...
                    value: function (e, i, n) {
                      ...
                      if (
                        ...
                        return (
                          this.update(e, i), t.nextTick(this.lazyLoadHandler)
                        );
                  ...
                  },
                  {
                    ...
                    value: function (e, i) {
                      var n = this,
                        r = this._valueFormatter(i.value),
                        a = r.src,
                        l = r.loading,
                        c = r.error;
                      ...
                      u && u.update({ src: a, loading: l, error: c }),
                        this._observer &&
    ...
    function (t, e, i) {
      ...
      function b(t, e, i, n) {
        void 0 === n && (n = !1),
          m.h || t.addEventListener(e, i, !!v && { capture: !1, passive: n });
      }
      function y(t, e, i) {
      ...
      function T(t, e, i, r) {
        ...
        return (
          Object(m.c)(e.duration) && (o.animationDuration = e.duration + "s"),
              ...
              s()([
                {
                  ...
                  style: o,
                  class: [C(), e.className],
                  on: { touchmove: e.lockScroll ? O : m.i },
                },
                h(r, !0),
              ]),
      ...
      function D(t) {
        ...
        if (e) {
          var i = t.$el,
            r = e.config,
            s = e.overlay;
          i && i.parentNode && i.parentNode.insertBefore(s.$el, i),
            n(s, I, r, { show: !0 });
        }
      }
      function E(t, e) {
        ...
        methods: {
          ...
          touchMove: function (t) {
            var e,
              i,
              n = t.touches[0];
            (this.deltaX = n.clientX < 0 ? 0 : n.clientX - this.startX),
          ...
          void 0 === t && (t = {}),
          {
            ...
            methods: {
              open: function () {
                this.$isServer ||
                  this.opened ||
                  (void 0 !== this.zIndex && (p.zIndex = this.zIndex),
                  (this.opened = !0),
                  this.renderOverlay(),
                  this.addLock());
              },
              addLock: function () {
                this.lockScroll &&
                  (b(document, "touchstart", this.touchStart),
      ...
      function Z(t, e, i, n) {
        var r = e.dot,
          ...
          a = Object(m.c)(o) && "" !== o;
        if (r || a)
          return t("div", s()([{ class: G({ dot: r }) }, h(n, !0)]), [
            r ? "" : e.info,
          ]);
      }
      ...
      function rt(t, e, i, n) {
        ...
        return t(
          ...
          [
            i.default && i.default(),
            a && t("img", { class: it("image"), attrs: { src: o } }),
            t(J, {
              attrs: { dot: e.dot, info: null != (r = e.badge) ? r : e.info },
            }),
          ]
        );
      }
          ...
          render: function () {
            ...
            if (this.shouldRender) {
              var i = this.round,
                ...
                s = "center" === n,
                o =
                  this.transition || (s ? "van-fade" : "van-popup-slide-" + n),
                a = {};
              if (Object(m.c)(r)) {
      ...
      function ft(t, e) {
        ...
        return t(
          "svg",
          { class: dt("circular"), attrs: { viewBox: "25 25 50 50" } },
          [
            t("circle", {
      ...
      function mt(t, e, i, n) {
        ...
        return t(
          "div",
          s()([{ class: dt([a, { vertical: e.vertical }]) }, h(n, !0)]),
          [
            t("span", { class: dt("spinner", a), style: l }, [ft(t, e)]),
            pt(t, e, i),
          ]
        );
      }
      ...
      function St(t, e, i, n) {
        ...
        return t(
          ...
          [
            ...
            (function () {
              var n =
                (null == i.description ? void 0 : i.description()) ||
                e.description;
              if (n) return t("div", { class: yt("description") }, [n]);
            })(),
            t("div", { class: yt("content") }, [
              e.actions &&
                e.actions.map(function (i, r) {
                  var s = i.disabled,
                    o = i.loading,
                    l = i.callback;
                  return t(
                    ...
                    [
                      o
                        ? t(vt, { class: yt("loading-icon") })
                        : [
                            t("span", { class: yt("name") }, [i.name]),
                            i.subname &&
                              t("div", { class: yt("subname") }, [i.subname]),
                          ],
                    ]
                  );
                }),
      ...
      var Pt = Object(l.a)("picker-column"),
        Lt = Pt[0],
        Nt = Pt[1];
      function At(t) {
      ...
      var Mt = Lt({
          ...
          methods: {
            setOptions: function (t) {
              JSON.stringify(t) !== JSON.stringify(this.options) &&
                ((this.options = It(t)), this.setIndex(this.defaultIndex));
            },
            ...
            getOptionText: function (t) {
              return Object(m.f)(t) && this.valueKey in t
                ? t[this.valueKey]
                : t;
            },
            setIndex: function (t, e) {
              var i = this,
                ...
                r = function () {
                  t !== i.currentIndex &&
                    ((i.currentIndex = t), e && i.$emit("change", t));
                };
              this.moving && n !== this.offset
                ? (this.transitionEndTrigger = r)
                : r(),
                (this.offset = n);
            },
            setValue: function (t) {
          ...
          render: function () {
            ...
            return t("div", { class: [Nt(), this.className] }, [
              t(
                "ul",
                {
                  ref: "wrapper",
        ...
        Ht = Ft({
          ...
          methods: {
            ...
            formatCascade: function () {
              for (
                ...
                for (
                  var i,
                    n = e.children,
                    r = null != (i = e.defaultIndex) ? i : +this.defaultIndex;
                  n[r] && n[r].disabled;
            ...
            genTitle: function () {
              ...
              return (
                e ||
                (this.title
                  ? t("div", { class: ["van-ellipsis", Vt("title")] }, [
                      this.title,
                    ])
                  : void 0)
              );
            ...
            genColumns: function () {
              ...
              return t(
                "div",
                { class: Vt("columns"), style: r, on: { touchmove: k } },
                [
                  this.genColumnItems(),
                  t("div", { class: Vt("mask"), style: s }),
                  t("div", {
                    class: ["van-hairline-unset--top-bottom", Vt("frame")],
                    style: n,
                  }),
                ]
              );
              ...
              return this.formattedColumns.map(function (i, n) {
                ...
                return e(Mt, {
                  attrs: {
                    ...
                    defaultIndex:
                      null != (r = i.defaultIndex) ? r : +t.defaultIndex,
          ...
          render: function (t) {
            return t("div", { class: Vt() }, [
              "top" === this.toolbarPosition ? this.genToolbar() : t(),
              this.loading ? t(vt, { class: Vt("loading") }) : t(),
        ...
        methods: {
          getList: function (t, e) {
            ...
            if (
              ...
              e &&
                (this.isOverseaCode(e) && "city" === t && (e = "9"),
              ...
              "city" === t
                ? (r = "000000".slice(2, 4))
                : "county" === t && (r = "000000".slice(4, 6)),
                i.unshift({ code: "" + e + r, name: this.placeholderMap[t] });
            }
            return i;
          },
          getIndex: function (t, e) {
            ...
            for (var r = 0; r < n.length; r++)
              if (n[r].code.slice(0, i) === e) return r;
            return 0;
          },
      ...
      var Qt = { url: String, replace: Boolean, to: [String, Object] },
        Gt = {
          icon: String,
          size: String,
          center: Boolean,
      ...
      function ee(t, e, i, n) {
        ...
        function v() {
          if (i.label || Object(m.c)(c))
            return t("div", { class: [te("label"), e.labelClass] }, [
              i.label ? i.label() : c,
            ]);
        }
            ...
            [
              ...
              (function () {
                if (p)
                  return t(
                    "div",
                    { class: [te("title"), e.titleClass], style: e.titleStyle },
              ...
              (function () {
                if (i.default || Object(m.c)(u))
                  return t(
                    "div",
                    { class: [te("value", { alone: !p }), e.valueClass] },
      ...
      var ie = Jt(ee);
      var ne =
        !m.h && /ios|iphone|ipad|ipod/.test(navigator.userAgent.toLowerCase());
      function re() {
        ne && F(z());
      }
      var se = Object(l.a)("field"),
        oe = se[0],
        ae = se[1],
        le = oe({
          inheritAttrs: !1,
          ...
          methods: {
              ...
              return t.reduce(function (t, i) {
                return t.then(function () {
                  if (!e.validateFailed) {
                    var t = e.formValue;
                    return (
                      i.formatter && (t = i.formatter(t, i)),
                      e.runSyncRule(t, i)
                        ? i.validator
                          ? e.runValidator(t, i).then(function (n) {
                              !1 === n &&
                                ((e.validateFailed = !0),
            ...
            updateValue: function (t, e) {
              ...
              if (
                (Object(m.c)(i) &&
                  t.length > i &&
                  (t =
                    this.value && this.value.length === +i
                      ? this.value
                      : t.slice(0, i)),
            ...
            genInput: function () {
              ...
              var c,
                u = e;
              return (
                "number" === e && ((u = "text"), (c = "decimal")),
                "digit" === e && ((u = "tel"), (c = "numeric")),
                t("input", s()([{ attrs: { type: u, inputmode: c } }, l]))
              );
            },
            ...
            getProp: function (t) {
              return Object(m.c)(this[t])
                ? this[t]
                : this.vanForm && Object(m.c)(this.vanForm[t])
                ? this.vanForm[t]
                : void 0;
            },
            genLabel: function () {
            ...
            return (
              ...
              e(
                ie,
                {
                  ...
                  scopedSlots: s,
                  class: ae(
                    ((t = { error: this.showError, disabled: n }),
                    (t["label-" + r] = r),
                    (t["min-height"] =
                ...
                [
                  e("div", { class: ae("body") }, [
                    ...
                    this.genRightIcon(),
                    i("button") &&
                      e("div", { class: ae("button") }, [i("button")]),
                  ]),
                  this.genWordLimit(),
                  this.genMessage(),
                ]
          ...
          methods: {
            ...
            genIcon: function () {
              ...
              return e || "success" === i || "fail" === i
                ...
                : "loading" === i
                ? t(vt, { class: de("loading"), attrs: { type: r } })
                : void 0;
            },
            genMessage: function () {
              var t = this.$createElement,
              ...
              if (Object(m.c)(i) && "" !== i)
                return "html" === e
                  ? t("div", { class: de("text"), domProps: { innerHTML: i } })
      ...
      function Se() {
        ...
        if (
          !(ve = ve.filter(function (t) {
            return (
              !t.$el.parentNode || ((e = t.$el), document.body.contains(e))
            );
            var e;
          })).length ||
          ge
      ...
      function ke(t) {
        ...
        return (
          ...
          (t = ye(t)),
          ((t = n({}, be, me[t.type || be.type], t)).clear = function () {
            (e.value = !1),
      ...
      function Te(t, e, i, n) {
        ...
        return t(
          ...
          [
            t("div", { class: Oe("content") }, [
              ((S = []),
              "left" === g && S.push(x()),
              (y = p ? v : i.default ? i.default() : e.text) &&
                S.push(t("span", { class: Oe("text") }, [y])),
              "right" === g && S.push(x()),
              S),
            ]),
          ]
              ...
              (function t(i) {
                i.forEach(function (i) {
                  e.push(i),
                    i.componentInstance &&
                      t(
                        i.componentInstance.$children.map(function (t) {
                          return t.$vnode;
                        })
                      ),
      ...
      var Ee,
        ...
        Ne = Pe({
          ...
          render: function () {
            ...
            return t(
              "div",
              { class: Le({ unfit: !this.safeAreaInsetBottom }) },
              [this.slots()]
            );
          },
        }),
        Ae = Object(l.a)("goods-action-button"),
        Me = Ae[0],
        ze = Ae[1],
        Fe = Me({
        ...
        We = Re({
          ...
          methods: {
            ...
            genButtons: function () {
              ...
              return i("div", { class: [Tt, He("footer")] }, [
                this.showCancelButton &&
                  i($e, {
                    attrs: {
                      size: "large",
            ...
            genContent: function (t, e) {
              ...
              if (n) {
                ...
                return i("div", { class: He("content", { isolated: !t }) }, [
                  i("div", s()([{}, l])),
                ]);
              }
            },
          ...
          render: function () {
            ...
            if (this.shouldRender) {
              var e = this.message,
                ...
                r =
                  n &&
                  t("div", { class: He("header", { isolated: !e && !i }) }, [
                    n,
                  ]);
              return t(
                "transition",
      ...
      function qe(t) {
        return m.h
          ...
          : new Promise(function (e, i) {
              var r;
              (Ee && ((r = Ee.$el), document.body.contains(r))) ||
                (Ee && Ee.$destroy(),
                (Ee = new (a.a.extend(We))({
                  el: document.createElement("div"),
      ...
      (qe.defaultOptions = {
        ...
        qe.resetDefaultOptions(),
        (qe.install = function () {
          a.a.use(We);
        }),
        (qe.Component = We),
        (a.a.prototype.$dialog = qe);
      var Ke = qe,
        Ue = Object(l.a)("address-edit-detail"),
        Ye = Ue[0],
        Xe = Ue[1],
        Qe = Ue[2],
        Ge = !m.h && /android/.test(navigator.userAgent.toLowerCase()),
        Ze = Ye({
          props: {
            value: String,
            errorMessage: String,
          ...
          methods: {
            ...
            genFinish: function () {
              var t = this.$createElement;
              if (this.value && this.focused && Ge)
                return t(
                  "div",
                  { class: Xe("finish"), on: { click: this.onFinish } },
                  [Qe("complete")]
                );
            },
      ...
      var ui = oi({
          ...
          computed: {
            areaListLoaded: function () {
              return (
                Object(m.f)(this.areaList) && Object.keys(this.areaList).length
              );
            },
            areaText: function () {
              var t = this.data,
          ...
          methods: {
            ...
            onDelete: function () {
              var t = this;
              Ke.confirm({ title: li("confirmDelete") })
                .then(function () {
          ...
          render: function (t) {
            var e = this,
              ...
              n = this.errorInfo,
              r = this.disableArea,
              s = this.hideBottomFields,
              o = function (t) {
                return function () {
                  return e.onFocus(t);
                };
              };
            return t("div", { class: ai() }, [
              t("div", { class: ai("fields") }, [
                t(le, {
                  attrs: {
                    clearable: !0,
                    label: li("name"),
        ...
        pi = di({
          ...
          render: function () {
            ...
            return t(
              "div",
              { class: fi([this.direction]), attrs: { role: "radiogroup" } },
              [this.slots()]
            );
          },
        }),
      ...
      function bi(t, e, i, n) {
        ...
        l
          ? ((m.color = p || c), (m.borderColor = c))
          : ((m.color = p), (m.background = c));
        ...
        return t(
          ...
          [
            t(
              "span",
              s()([{ key: "content", style: m, class: gi([v, o]) }, h(n, !0)]),
        ...
        Si = function (t) {
          ...
          return {
            ...
            computed: {
              ...
              tabindex: function () {
                return this.isDisabled || ("radio" === n && !this.checked)
                  ? -1
                  : 0;
              },
            },
            methods: {
              onClick: function (t) {
                var e = this,
                  ...
                  n = this.$refs.icon,
                  r = n === i || n.contains(i);
                this.isDisabled || (!r && this.labelDisabled)
                  ? this.$emit("click", t)
                  : (this.toggle(),
                    setTimeout(function () {
                      e.$emit("click", t);
              ...
              genIcon: function () {
                ...
                return t(
                  "div",
                  {
                    ...
                    class: i("icon", [
                      this.shape,
                      { disabled: this.isDisabled, checked: e },
                    ]),
        ...
        return t(
          ...
          [
            t(
              ...
              s()([
                {
                  attrs: { border: !1, valueClass: Oi("value") },
                  scopedSlots: {
                    default: function () {
                      var r = e.data,
                        s = [
                          t("div", { class: Oi("name") }, [
                            ...
                            i.tag
                              ? i.tag(n({}, e.data))
                              : e.data.isDefault && e.defaultTagText
                              ? t(
                                  yi,
                                  {
                          ...
                          t("div", { class: Oi("address") }, [r.address]),
                        ];
                      return a && !o
                        ? t(xi, { attrs: { name: r.id, iconSize: 18 } }, [s])
                        : s;
                    },
                    "right-icon": function () {
                      return t(st, {
      ...
      function ji(t, e, i, n) {
          ...
          if (r)
            return r.map(function (r, o) {
              return t($i, {
                ...
                key: r.id,
                scopedSlots: { bottom: i["item-bottom"], tag: i.tag },
                on: {
                  select: function () {
                    d(n, s ? "select-disabled" : "select", r, o),
                      s || d(n, "input", r.id);
                  },
                  edit: function () {
        ...
        return t("div", s()([{ class: Di() }, h(n)]), [
          null == i.top ? void 0 : i.top(),
          t(pi, { attrs: { value: e.value } }, [o]),
          e.disabledText &&
            t("div", { class: Di("disabled-text") }, [e.disabledText]),
          a,
          null == i.default ? void 0 : i.default(),
          t("div", { class: Di("bottom") }, [
            t($e, {
              attrs: {
                round: !0,
                block: !0,
          ...
          methods: {
            hasContent: function () {
              return !!(
                ...
                (Object(m.c)(this.content) && "" !== this.content)
              );
            },
            renderContent: function () {
              ...
              if (!t && this.hasContent())
                return this.$scopedSlots.content
                  ? this.$scopedSlots.content()
                  : Object(m.c)(e) && Object(Li.b)(i) && +i > e
                  ? e + "+"
                  : i;
            },
      ...
      function Vi(t) {
        return (
          ...
          !Object(Li.a)(t.getTime())
        );
      }
      var Ri = Object(l.a)("calendar"),
        Hi = Ri[0],
        _i = Ri[1],
        Wi = Ri[2];
      function qi(t, e) {
      ...
      var Zi = (0, Object(l.a)("calendar-month")[0])({
          ...
          computed: {
            title: function () {
              return (
                (t = this.date),
                Wi("monthTitle", t.getFullYear(), t.getMonth() + 1)
              );
              var t;
            },
            ...
            placeholders: function () {
              for (
                var t = [],
                  e = Math.ceil((this.totalDay + this.offset) / 7),
                  i = 1;
                i <= e;
                i++
              )
                t.push({ type: "placeholder" });
              return t;
            },
            days: function () {
              for (
          ...
          methods: {
            ...
            scrollIntoView: function (t) {
              var e = this.$refs,
                ...
                n = e.month,
                r =
                  (this.showSubtitle ? i : n).getBoundingClientRect().top -
            ...
            getRangeDayType: function (t) {
              ...
              var s = Ki(t, n);
              return 0 === r && 0 === s && this.allowSameDay
                ? "start-end"
                : 0 === r
                ? "start"
                : 0 === s
            ...
            getDayStyle: function (t, e) {
              ...
              return "placeholder" === t
                ? ((i.width = "100%"), i)
                : (0 === e && (i.marginLeft = (100 * this.offset) / 7 + "%"),
                  this.color &&
                    ("start" === t ||
                    "end" === t ||
                    "start-end" === t ||
                    ...
                    "multiple-middle" === t
                      ...
                      : "middle" === t && (i.color = this.color)),
                  i);
            },
            genTitle: function () {
              var t = this.$createElement;
              if (this.showMonthTitle)
                return t("div", { class: _i("month-title") }, [this.title]);
            },
            genMark: function () {
              var t = this.$createElement;
              if (this.showMark && this.shouldRender)
                return t("div", { class: _i("month-mark") }, [
            ...
            genDays: function () {
              ...
              return t(
                "div",
                { ref: "days", attrs: { role: "grid" }, class: _i("days") },
          ...
          render: function () {
            var t = arguments[0];
            return t("div", { class: _i("month"), ref: "month" }, [
              this.genTitle(),
              this.genDays(),
            ]);
          },
          ...
          methods: {
            ...
            genSubtitle: function () {
              ...
              if (this.showSubtitle)
                return t("div", { class: _i("header-subtitle") }, [
                  this.subtitle,
                ]);
            },
            genWeekDays: function () {
              ...
              return t("div", { class: _i("weekdays") }, [
                n.map(function (e) {
        ...
        tn = Hi({
          ...
          methods: {
              ...
              (this.poppable && !this.value) ||
                this.$nextTick(function () {
                  (t.bodyHeight = Math.floor(
                    t.$refs.body.getBoundingClientRect().height
                  )),
                    t.onScroll(),
                    t.scrollIntoView();
                });
                ...
                if ("range" === i) {
                  ...
                  if (r && !s) {
                    ...
                    1 === o
                      ...
                      : -1 === o
                      ? this.select([e, null])
                      : this.allowSameDay && this.select([e, e], !0);
                  ...
                  if (
                    ...
                    this.maxRange && n.length >= this.maxRange
                      ? xe(this.rangePrompt || Wi("rangePrompt", this.maxRange))
            ...
            genFooter: function () {
              return (0, this.$createElement)(
                "div",
                { class: _i("footer", { unfit: !this.safeAreaInsetBottom }) },
        ...
        sn = nn({
          ...
          computed: {
            style: function () {
              var t = {};
              return (
                Object(m.c)(this.width) && (t.width = Object(Y.a)(this.width)),
                Object(m.c)(this.height) &&
                  (t.height = Object(Y.a)(this.height)),
                Object(m.c)(this.radius) &&
                  ((t.overflow = "hidden"),
      ...
      function cn(t, e, i, n) {
        ...
        function p() {
          if (i.tag || e.tag)
            return t("div", { class: ln("tag") }, [
              i.tag
                ? i.tag()
                : t(yi, { attrs: { mark: !0, type: "danger" } }, [e.tag]),
            ]);
        }
        return t("div", s()([{ class: ln() }, h(n, !0)]), [
          t("div", { class: ln("header") }, [
            (function () {
              if (i.thumb || o)
                return t(
                  "a",
            ...
            t("div", { class: ln("content", { centered: e.centered }) }, [
              t("div", [
                i.title
                  ? i.title()
                  : e.title
                  ? t(
                      "div",
                      { class: [ln("title"), "van-multi-ellipsis--l2"] },
                      [e.title]
                    )
                  : void 0,
                i.desc
                  ? i.desc()
                  : e.desc
                  ? t("div", { class: [ln("desc"), "van-ellipsis"] }, [e.desc])
                  : void 0,
                null == i.tags ? void 0 : i.tags(),
              ]),
              u &&
                t("div", { class: "van-card__bottom" }, [
                  null == (r = i["price-top"]) ? void 0 : r.call(i),
                  (function () {
                    if (l)
                      return t("div", { class: ln("price") }, [
                        i.price
                          ? i.price()
                          : ((n = e.price.toString().split(".")),
                            t("div", [
                              t("span", { class: ln("price-currency") }, [
                                e.currency,
                              ]),
                              t("span", { class: ln("price-integer") }, [n[0]]),
                              ".",
                              t("span", { class: ln("price-decimal") }, [n[1]]),
                            ])),
                      ]);
                    var n;
                  })(),
                  (function () {
                    if (c) {
                      ...
                      return t("div", { class: ln("origin-price") }, [
          ...
          (function () {
            if (i.footer)
              return t("div", { class: ln("footer") }, [i.footer()]);
          })(),
        ]);
      }
      cn.props = {
      ...
      var un,
        ...
        mn = fn({
          ...
          render: function (t) {
            ...
            if (r || i.animated) {
              var s = i.scrollspy || n,
                o = this.inited || i.scrollspy || !i.lazyRender ? r : t();
              return i.animated
                ? t(
                    "div",
                    {
      ...
      var bn = Object(l.a)("tab"),
          ...
          methods: {
            ...
            genText: function () {
              var t = this.$createElement,
                e = t(
                  "span",
                  { class: Sn("text", { ellipsis: !this.scrollable }) },
                  [this.slots() || this.title]
                );
              return this.dot || (Object(m.c)(this.info) && "" !== this.info)
                ? t("span", { class: Sn("text-wrapper") }, [
                    e,
                    t(J, { attrs: { dot: this.dot, info: this.info } }),
                  ])
                : e;
            },
          },
        ...
        On = wn({
          mixins: [
            W(function (t, e) {
              if (
                (this.scroller || (this.scroller = N(this.$el)), this.observer)
              ) {
          ...
          computed: {
            ...
            style: function () {
              if (this.fixed) {
                var t = {};
                return (
                  Object(m.c)(this.zIndex) && (t.zIndex = this.zIndex),
                  this.offsetTopPx &&
                    this.fixed &&
              ...
              if (!vn(this.$el)) {
                ...
                if (e) {
                  ...
                  if (n + i + this.height > o) {
                    ...
                    return (
                      a < this.height
                        ? ((this.fixed = !0), (this.transform = -(a + i)))
                        : (this.fixed = !1),
                      void s()
                    );
                  }
          ...
          render: function () {
            ...
            return t("div", { style: i }, [
              t("div", { class: Cn({ fixed: e }), style: this.style }, [
                this.slots(),
              ]),
            ]);
          },
          ...
          methods: {
            ...
            genChildren: function () {
              ...
              return this.animated
                ? t("div", { class: Bn("track"), style: this.style }, [
                    this.slots(),
                  ])
                : this.slots();
            },
          ...
          watch: {
            ...
            currentIndex: function () {
              this.scrollIntoView(),
                ...
                this.stickyFixed &&
                  !this.scrollspy &&
                  F(Math.ceil(V(this.$el) - this.offsetTopPx));
            },
            scrollspy: function (t) {
              t
                ? b(this.scroller, "scroll", this.onScroll, !0)
                : y(this.scroller, "scroll", this.onScroll);
            },
          },
          mounted: function () {
            this.init();
          ...
          methods: {
            ...
            setLine: function () {
              ...
              this.$nextTick(function () {
                ...
                if (i && i[t.currentIndex] && "line" === t.type && !vn(t.$el)) {
                  ...
                  if (
                    (e && (a.transitionDuration = t.duration + "s"),
                    Object(m.c)(s))
                  ) {
                    var l = Object(Y.a)(s);
            ...
            scrollIntoView: function (t) {
              ...
              if (this.scrollable && e && e[this.currentIndex]) {
                ...
                !(function (t, e, i) {
                  ...
                  !(function i() {
                    (t.scrollLeft += (e - r) / s),
                      ++n < s && (un = Object(Fi.c)(i));
                  })();
                })(
                  i,
                  n.offsetLeft - (i.offsetWidth - n.offsetWidth) / 2,
                  t ? 0 : +this.duration
                );
              }
            },
            ...
            getCurrentIndexOnScroll: function () {
              for (var t, e = this.children, i = 0; i < e.length; i++) {
                if (
                  (P((t = e[i].$el)) ? 0 : t.getBoundingClientRect().top) >
                  this.scrollOffset
                )
                  return 0 === i ? 0 : i - 1;
              }
                ...
                [
                  i(
                    ...
                    [
                      ...
                      o,
                      "line" === n &&
                        i("div", { class: jn("line"), style: this.lineStyle }),
                      this.slots("nav-right"),
                    ]
                  ),
                ]
              );
            return i("div", { class: jn([n]) }, [
              this.sticky
                ? i(
                    On,
                    {
        ...
        zn = Nn({
          ...
          computed: {
            textKey: function () {
              var t;
              return (
                (null == (t = this.fieldNames) ? void 0 : t.text) || "text"
              );
            },
            valueKey: function () {
              var t;
              return (
                (null == (t = this.fieldNames) ? void 0 : t.value) || "value"
              );
            },
            childrenKey: function () {
              var t;
              return (
                (null == (t = this.fieldNames) ? void 0 : t.children) ||
                "children"
              );
            },
          },
          watch: {
            options: { deep: !0, handler: "updateTabs" },
            value: function (t) {
              var e = this;
              if (
                (t || 0 === t) &&
                -1 !==
                  this.tabs
                    .map(function (t) {
                      var i;
                      return null == (i = t.selectedOption)
                        ? void 0
                        : i[e.valueKey];
                    })
                    .indexOf(t)
          ...
          methods: {
            getSelectedOptionsByValue: function (t, e) {
              for (var i = 0; i < t.length; i++) {
                ...
                if (n[this.childrenKey]) {
                  var r = this.getSelectedOptionsByValue(
                    n[this.childrenKey],
                    e
                  );
            ...
            updateTabs: function () {
              ...
              if (this.value || 0 === this.value) {
                var e = this.getSelectedOptionsByValue(
                  this.options,
                  this.value
                );
                if (e) {
                  var i = this.options;
                  return (
                    (this.tabs = e.map(function (e) {
                      var n = { options: i, selectedOption: e },
                        r = i.filter(function (i) {
                          return i[t.valueKey] === e[t.valueKey];
                        });
                      return r.length && (i = r[0][t.childrenKey]), n;
                    })),
                    i && this.tabs.push({ options: i, selectedOption: null }),
            ...
            onSelect: function (t, e) {
              var i = this;
              if (
                ((this.tabs[e].selectedOption = t),
                this.tabs.length > e + 1 &&
                  (this.tabs = this.tabs.slice(0, e + 1)),
                t[this.childrenKey])
              ) {
                var n = { options: t[this.childrenKey], selectedOption: null };
                this.tabs[e + 1]
                  ? this.$set(this.tabs, e + 1, n)
                  : this.tabs.push(n),
                  this.$nextTick(function () {
                    i.activeTab++;
                  });
              ...
              this.$emit("input", t[this.valueKey]),
                this.$emit("change", s),
                t[this.childrenKey] || this.$emit("finish", s);
            },
            onClose: function () {
              this.$emit("close");
            },
          ...
          render: function () {
            var t = arguments[0];
            return t("div", { class: An() }, [
              this.renderHeader(),
              this.renderTabs(),
            ]);
          },
        }),
        Fn = Object(l.a)("cell-group"),
        Vn = Fn[0],
        Rn = Fn[1];
      function Hn(t, e, i, n) {
        var r,
        ...
        return e.title || i.title
          ? t("div", [
              t("div", { class: Rn("title") }, [i.title ? i.title() : e.title]),
              o,
            ])
          : o;
      }
      ...
      var er = Gn({
          ...
          computed: {
            ...
            hoverStyle: function () {
              ...
              return {
                stroke:
                  "" + (this.gradient ? "url(#" + this.uid + ")" : this.color),
              ...
              if (this.gradient) {
                var i = Object.keys(this.color)
                  ...
                  .map(function (i, n) {
                    return e("stop", {
                      key: n,
                      attrs: { offset: i, "stop-color": t.color[i] },
                    });
                  });
                return e("defs", [
                  e(
            ...
            rate: {
              handler: function (t) {
                (this.startTime = Date.now()),
                  ...
                  this.speed
                    ? (Object(Fi.a)(this.rafId),
                      (this.rafId = Object(Fi.c)(this.animate)))
          ...
          methods: {
            animate: function () {
              var t = Date.now(),
                e =
                  Math.min((t - this.startTime) / this.duration, 1) *
                    (this.endRate - this.startRate) +
                  this.startRate;
              this.$emit("input", tr(parseFloat(e.toFixed(1)))),
                (this.increase ? e < this.endRate : e > this.endRate) &&
                  (this.rafId = Object(Fi.c)(this.animate));
            },
          },
          render: function () {
            var t = arguments[0];
            return t("div", { class: Zn(), style: this.style }, [
              t(
                "svg",
                {
                  attrs: {
              ...
              this.slots() ||
                (this.text && t("div", { class: Zn("text") }, [this.text])),
            ]);
          },
        }),
        ir = Object(l.a)("col"),
        ...
        cr = ar({
          ...
          render: function () {
            ...
            return e(
              "div",
              { class: [lr(), ((t = {}), (t[Bt] = this.border), t)] },
              [this.slots()]
            );
          },
        }),
        ur = Object(l.a)("collapse-item"),
        hr = ur[0],
        dr = ur[1],
        fr = ["title", "icon", "right-icon"],
        pr = hr({
            ...
            genContent: function () {
              ...
              if (this.inited)
                return t(
                  ...
                  [
                    t("div", { ref: "content", class: dr("content") }, [
                      this.slots(),
                    ]),
                  ]
                );
          ...
          render: function () {
            ...
            return t(
              "div",
              { class: [dr({ border: this.index && this.border })] },
              [this.genTitle(), this.genContent()]
            );
          },
        }),
        mr = Object(l.a)("contact-card"),
        vr = mr[0],
        gr = mr[1],
        br = mr[2];
      function yr(t, e, i, n) {
        ...
        return t(
          ...
          [
            "add" === r
              ? e.addText || br("addText")
              : [
                  t("div", [br("name") + "：" + e.name]),
                  t("div", [br("tel") + "：" + e.tel]),
                ],
          ]
        );
      ...
      var Sr = vr(yr),
        ...
        Tr = xr({
          ...
          render: function () {
            ...
            return e("div", { class: wr() }, [
              e("div", { class: wr("fields") }, [
                e(le, {
                  attrs: {
                    clearable: !0,
                    maxlength: "30",
      ...
      function Er(t, e, i, n) {
          ...
          e.list.map(function (i, r) {
            ...
            return t(ie, {
              ...
              scopedSlots: {
                ...
                "right-icon": function () {
                  return t(xi, {
                    attrs: { name: i.id, iconSize: 16, checkedColor: Ct },
                    on: { click: s },
                  });
                },
              },
        ...
        return t("div", s()([{ class: Ir() }, h(n)]), [
          t(pi, { attrs: { value: e.value }, class: Ir("group") }, [r]),
          t("div", { class: Ir("bottom") }, [
            t($e, {
              attrs: {
                round: !0,
                block: !0,
        ...
        Mr = Nr({
            ...
            formattedTime: function () {
              return (function (t, e) {
                ...
                if (
                  (-1 === t.indexOf("DD")
                    ? (n += 24 * i)
                    : (t = t.replace("DD", Object(Pr.b)(i))),
                  -1 === t.indexOf("HH")
                    ? (r += 60 * n)
                    : (t = t.replace("HH", Object(Pr.b)(n))),
                  -1 === t.indexOf("mm")
                    ? (s += 60 * r)
                    : (t = t.replace("mm", Object(Pr.b)(r))),
                  -1 === t.indexOf("ss")
                    ? (o += 1e3 * s)
                    : (t = t.replace("ss", Object(Pr.b)(s))),
                  -1 !== t.indexOf("S"))
                ) {
          ...
          activated: function () {
            this.keepAlivePaused &&
              ((this.counting = !0), (this.keepAlivePaused = !1), this.tick());
          },
          deactivated: function () {
          ...
          methods: {
            ...
            microTick: function () {
              ...
              this.rafId = Object(Fi.c)(function () {
                t.counting &&
                  (t.setRemain(t.getRemain()), t.remain > 0 && t.microTick());
              });
            },
            macroTick: function () {
              var t = this;
              this.rafId = Object(Fi.c)(function () {
                if (t.counting) {
                  ...
                  (e = n),
                    (i = t.remain),
                    (Math.floor(e / 1e3) !== Math.floor(i / 1e3) || 0 === n) &&
                      t.setRemain(n),
          ...
          render: function () {
            var t = arguments[0];
            return t("div", { class: Ar() }, [
              this.slots("default", this.timeData) || this.formattedTime,
            ]);
          },
        }),
        zr = Object(l.a)("coupon"),
        Fr = zr[0],
        Vr = zr[1],
        Rr = zr[2];
      function Hr(t) {
        ...
        return (
          e.getFullYear() +
          "." +
          Object(Pr.b)(e.getMonth() + 1) +
          "." +
          Object(Pr.b)(e.getDate())
        );
      }
      function _r(t) {
      ...
      var Wr = Fr({
          ...
          computed: {
            ...
            faceAmount: function () {
              ...
              return e.discount
                ? Rr(
                    "discount",
                    ((t = e.discount) / 10).toFixed(t % 10 == 0 ? 0 : 1)
                  )
                : "";
            },
          ...
          render: function () {
            ...
            return t("div", { class: Vr({ disabled: i }) }, [
              t("div", { class: Vr("content") }, [
                t("div", { class: Vr("head") }, [
                  t("h2", {
                    class: Vr("amount"),
                    domProps: { innerHTML: this.faceAmount },
                  }),
                  t("p", { class: Vr("condition") }, [
                    this.coupon.condition || this.conditionMessage,
                  ]),
                ]),
                t("div", { class: Vr("body") }, [
                  t("p", { class: Vr("name") }, [e.name]),
                  t("p", { class: Vr("valid") }, [this.validPeriod]),
                  !this.disabled &&
                    t(qn, {
                      attrs: { size: 18, value: this.chosen, checkedColor: Ct },
                      class: Vr("corner"),
                    }),
                ]),
              ]),
          ...
          o = (function (t) {
            ...
            if (r) {
              ...
              return (
                Object(m.c)(r.value)
                  ? (s = r.value)
                  : Object(m.c)(r.denominations) && (s = r.denominations),
                "-" + n + " " + (s / 100).toFixed(2)
              );
            }
      ...
      var Qr = Kr(Xr),
        ...
        es = Zr({
          ...
          render: function () {
            var t = this,
              ...
              r = this.showCount ? " (" + i.length + ")" : "",
              s = (this.enabledTitle || ts("enable")) + r,
              o = this.showCount ? " (" + n.length + ")" : "",
              a = (this.disabledTitle || ts("disabled")) + o,
              l =
                this.showExchangeBar &&
                e("div", { class: Jr("exchange-bar") }, [
                  e(le, {
                    attrs: {
                      clearable: !0,
                      border: !1,
              ...
              e("div", { class: Jr("bottom") }, [
                e($e, {
                  ...
                  attrs: {
                    ...
                    type: "danger",
                    block: !0,
                    text: this.closeButtonText || ts("close"),
                  },
                  class: Jr("close"),
                  on: { click: c(-1) },
                }),
        ...
        rs = (0, Object(l.a)("time-picker")[0])({
          ...
          methods: {
            formatValue: function (t) {
              t ||
                (t =
                  Object(Pr.b)(this.minHour) +
                  ":" +
                  Object(Pr.b)(this.minMinute));
              var e = t.split(":"),
                i = e[0],
                n = e[1];
              return (
                (i = Object(Pr.b)(Dt(i, this.minHour, this.maxHour))) +
                ":" +
                (n = Object(Pr.b)(Dt(n, this.minMinute, this.maxMinute)))
              );
            },
            updateInnerValue: function () {
              var t = this.getPicker().getIndexes(),
                ...
                r = n[0],
                s = n[1],
                o = r.values[e] || r.values[0],
                a = s.values[i] || s.values[0];
        ...
        ss = new Date().getFullYear(),
        os = (0, Object(l.a)("date-picker")[0])({
          mixins: [ns],
          props: n({}, is, {
            ...
            ranges: function () {
              var t = this.getBoundary(
                ...
                c = [
                  ...
                  { type: "day", range: [l, i] },
                  { type: "hour", range: [o.minHour, r] },
                  { type: "minute", range: [o.minMinute, s] },
                ];
              switch (this.type) {
                case "date":
                  c = c.slice(0, 3);
              ...
              if (this.columnsOrder) {
                var u = this.columnsOrder.concat(
                  c.map(function (t) {
                    return t.type;
                  })
                );
          ...
          methods: {
            ...
            getBoundary: function (t, e) {
              ...
              return (
                "max" === t &&
                  ((s = 12),
                  (o = Gi(e.getFullYear(), e.getMonth() + 1)),
                  (a = 23),
                  (l = 59)),
                e.getFullYear() === r &&
                  ((s = n.getMonth() + 1),
            ...
            updateInnerValue: function () {
              ...
              "month-day" === r
                ...
                : ((t = o("year")),
                  (e = o("month")),
                  (i = "year-month" === r ? 1 : o("day")));
              var a = Gi(t, e);
              i = i > a ? a : i;
              var l = 0,
                c = 0;
              "datehour" === r && (l = o("hour")),
                "datetime" === r && ((l = o("hour")), (c = o("minute")));
        ...
        as = Object(l.a)("datetime-picker"),
        ls = as[0],
        cs = as[1],
        us = ls({
          props: n({}, rs.props, os.props),
          methods: {
            getPicker: function () {
          ...
          s()([
            {
              ...
              class: fs(
                ((r = { dashed: e.dashed, hairline: e.hairline }),
                (r["content-" + e.contentPosition] = i.default),
                r)
              ),
            },
            h(n, !0),
      ...
      var ms = ds(ps),
        ...
        ys = gs({
            ...
            toggle: function (t, e) {
              void 0 === t && (t = !this.showPopup),
                ...
                t !== this.showPopup &&
                  ...
                  (this.showPopup = t),
                  t && (this.parent.updateOffset(), (this.showWrapper = !0)));
            },
          ...
          render: function () {
            var t = this,
              ...
              h = { zIndex: n };
            return (
              "down" === a ? (h.top = r + "px") : (h.bottom = r + "px"),
              e("div", [
                e(
                  "div",
                  {
                    directives: [{ name: "show", value: this.showWrapper }],
                    ref: "wrapper",
                    style: h,
                    class: bs([a]),
        ...
        Ss = function (t) {
          return {
            props: { closeOnClickOutside: { type: Boolean, default: !0 } },
            data: function () {
              var e = this;
              return {
        ...
        ks = Object(l.a)("dropdown-menu"),
        xs = ks[0],
        ws = ks[1],
        Cs = xs({
          mixins: [
            De("vanDropdownMenu"),
            Ss({ event: "click", method: "onClickOutside" }),
          ],
          props: {
            zIndex: [Number, String],
            activeColor: String,
          ...
          methods: {
            updateOffset: function () {
              if (this.$refs.bar) {
                ...
                "down" === this.direction
                  ...
                  : (this.offset = window.innerHeight - t.top);
              }
            },
            toggleItem: function (t) {
              this.children.forEach(function (e, i) {
                i === t
                  ? e.toggle()
                  : e.showPopup && e.toggle(!1, { immediate: !0 });
              });
            },
                  ...
                  [
                    e(
                      "span",
                      {
                        ...
                        style: { color: i.showPopup ? t.activeColor : "" },
                      },
                      [
            ...
            return t(
              ...
              [
                ...
                t("g", { attrs: { fill: "none", "fill-rule": "evenodd" } }, [
                  ...
                  t("path", {
                    attrs: { fill: "url(#" + Os + "7)", d: "M0 139h160v21H0z" },
                  }),
                  t("path", {
                    attrs: {
        ...
        Es = Bs({
          ...
          methods: {
            genImageContent: function () {
              ...
              return (
                -1 !== Ds.indexOf(i) &&
                  (i = "https://img01.yzcdn.cn/vant/empty-image-" + i + ".png"),
                t("img", { attrs: { src: i } })
              );
            },
            genImage: function () {
              ...
              return t("div", { class: Is("image"), style: e }, [
        ...
        Ns = Ps({
          ...
          render: function () {
            var t = arguments[0];
            return t("form", { class: Ls(), on: { submit: this.onSubmit } }, [
              this.slots(),
            ]);
          },
        }),
        As = Object(l.a)("goods-action-icon"),
        Ms = As[0],
        zs = As[1],
        Fs = Ms({
          mixins: [Ie("vanGoodsAction")],
          ...
          render: function () {
            ...
            return e(
              "div",
              {
                ...
                class: [
                  Hs(),
                  ((t = {}), (t[Tt] = this.border && !this.gutter), t),
                ],
              },
              [this.slots()]
            );
        ...
        Us = qs({
          ...
          methods: {
            ...
            getText: function () {
              ...
              return (
                e ||
                (this.text
                  ? t("span", { class: Ks("text") }, [this.text])
                  : void 0)
              );
            },
            genContent: function () {
          ...
          render: function () {
            var t,
              ...
              a = i.direction,
              l = i.clickable;
            return e("div", { class: [Ks({ square: s })], style: this.style }, [
              e(
                "div",
                {
                  ...
                  class: [
                    Ks("content", [
                      a,
                      { center: n, square: s, clickable: l, surround: r && o },
                    ]),
                    ((t = {}), (t[Ot] = r), t),
                  ],
                  on: { click: this.onClick },
          ...
          methods: {
            ...
            onTouchEnd: function () {
              if (this.touchable && this.swiping) {
                ...
                if (
                  (Math.abs(i) > 0.25 || Math.abs(e) > t / 2) &&
                  this.isCorrectDirection
                ) {
            ...
            move: function (t) {
              ...
              if (!(a <= 1)) {
                ...
                (this.active = d),
                  (this.offset = f),
                  s && d !== l && this.$emit("change", this.activeIndicator);
              }
            },
            prev: function () {
              var t = this;
            ...
            genIndicator: function () {
              ...
              return (
                ...
                (this.showIndicators && i > 1
                  ? e(
                      "div",
                      { class: Js("indicators", { vertical: this.vertical }) },
                      [
                        Array.apply(void 0, Array(i)).map(function (i, r) {
                          return e("i", {
        ...
        ro = io({
          ...
          render: function () {
            ...
            return t(
              "div",
              { class: no(), style: this.style, on: n({}, this.$listeners) },
      ...
      var oo,
        ao = {
          ...
          methods: {
            ...
            setScale: function (t) {
              (t = Dt(t, +this.minZoom, +this.maxZoom)) !== this.scale &&
                ((this.scale = t),
                this.$emit("scale", { scale: this.scale, index: this.active }));
            },
            ...
            onTouchStart: function (t) {
              ...
              this.touchStart(t),
                ...
                this.zooming &&
                  ...
                  (this.startDistance = so(t.touches)));
            },
            onTouchMove: function (t) {
              var e = t.touches;
              if (
                ...
                (this.moveX = Dt(i, -this.maxMoveX, this.maxMoveX)),
                  (this.moveY = Dt(n, -this.maxMoveY, this.maxMoveY));
              }
              if (this.zooming && 2 === e.length) {
                var r = so(e),
                  s = (this.startScale * r) / this.startDistance;
                this.setScale(s);
              }
            },
          ...
          render: function () {
            ...
            return t(ro, { class: Qs("swipe-item") }, [
              t(sn, {
        ...
        uo = function (t, e) {
          if ((void 0 === e && (e = 0), !m.h)) {
            oo ||
              ((oo = new (a.a.extend(lo))({
                el: document.createElement("div"),
              })),
              document.body.appendChild(oo.$el),
              oo.$on("change", function (t) {
            ...
            return (
              n(oo, co, i),
              oo.$once("input", function (t) {
                oo.value = t;
              }),
              oo.$once("closed", function () {
                oo.images = [];
              }),
              i.onClose && (oo.$off("close"), oo.$once("close", i.onClose)),
              oo
            );
          }
        };
        ...
        vo = po({
          ...
          methods: {
            ...
            getRect: function (t, e) {
              ...
              return (
                (this.rect.height = i.height),
                t === window || t === document.body
                  ? (this.rect.top = i.top + z())
                  : (this.rect.top = i.top + A(t) - e.top),
                this.rect
              );
            },
          },
          render: function () {
            ...
            return e(
              "div",
              { style: { height: i ? this.rect.height + "px" : null } },
              [
                e(
                  "div",
                  {
      ...
      var go = Object(l.a)("index-bar"),
          ...
          methods: {
            onScroll: function () {
              ...
              if (!vn(this.$el)) {
                ...
                (this.activeAnchorIndex = this.indexList[r]),
                  this.sticky &&
                    this.children.forEach(function (s, o) {
                      if (o === r || o === r - 1) {
                      ...
                      if (o === r)
                        (s.active = !0),
                          (s.top =
                            Math.max(t.stickyOffsetTop, n[o].top - e) + i.top);
                      else if (o === r - 1) {
                        var l = n[r].top - e;
            ...
            getActiveAnchorIndex: function (t, e) {
              for (var i = this.children.length - 1; i >= 0; i--) {
                ...
                if (
                  t + (this.sticky ? n + this.stickyOffsetTop : 0) >=
                  e[i].top
                )
                  return i;
              }
            ...
            onTouchMove: function (t) {
              if ((this.touchMove(t), "vertical" === this.direction)) {
                ...
                var e = t.touches[0],
                  i = e.clientX,
                  n = e.clientY,
                  r = document.elementFromPoint(i, n);
                if (r) {
                  var s = r.dataset.index;
                  this.touchActiveIndex !== s &&
                    ((this.touchActiveIndex = s), this.scrollToElement(r));
                }
              }
            },
            scrollTo: function (t) {
          ...
          methods: {
                  ...
                  if (
                    !(
                      (e = n.getBoundingClientRect
                        ...
                        : { top: 0, bottom: n.innerHeight }).bottom - e.top
                    ) ||
                    vn(i)
                  )
                    return !1;
            ...
            genLoading: function () {
              ...
              if (this.innerLoading && !this.finished)
                return t("div", { key: "loading", class: Oo("loading") }, [
                  this.slots("loading") ||
                    t(vt, { attrs: { size: "16" } }, [
                      this.loadingText || To("loading"),
                    ]),
                ]);
            },
            ...
            genLeft: function () {
              ...
              return (
                e || [
                  ...
                  this.leftText &&
                    t("span", { class: Eo("text") }, [this.leftText]),
                ]
              );
            },
            genRight: function () {
              ...
              return (
                e ||
                (this.rightText
                  ? t("span", { class: Eo("text") }, [this.rightText])
                  : void 0)
              );
            },
            genNavBar: function () {
              ...
              return e(
                ...
                [
                  e("div", { class: Eo("content") }, [
                    this.hasLeft() &&
                      e(
                        "div",
                        { class: Eo("left"), on: { click: this.onClickLeft } },
                        [this.genLeft()]
                      ),
        ...
        Ao = Lo({
          ...
          watch: {
            scrollable: "start",
            text: { handler: "start", immediate: !0 },
          },
          activated: function () {
            this.start();
          },
              ...
              this.reset(),
                ...
                (this.startTimer = setTimeout(function () {
                  ...
                  if (i && n && !1 !== t.scrollable) {
                    var r = i.getBoundingClientRect().width,
                      s = n.getBoundingClientRect().width;
                    (t.scrollable || s > r) &&
                      Object(Fi.b)(function () {
                        (t.offset = -s),
                          (t.duration = s / t.speed),
                          (t.wrapWidth = r),
                          (t.contentWidth = s);
                      });
                  }
          ...
          render: function () {
            ...
            function l() {
              ...
              return (
                t ||
                (r
                  ? e(st, { class: No("left-icon"), attrs: { name: r } })
                  : void 0)
              );
            }
            function c() {
      ...
      function Vo(t, e, i, n) {
        ...
        return t(
          ...
          [(null == i.default ? void 0 : i.default()) || e.message]
        );
      }
      Vo.props = n({}, K, {
        color: String,
        ...
        if (!m.h)
          return (
            ...
            (t = n(
              {},
              Wo.currentOptions,
              ((e = t), Object(m.f)(e) ? e : { message: e })
            )),
            n(Ho, t),
            clearTimeout(Ro),
            t.duration &&
              t.duration > 0 &&
              (Ro = setTimeout(Wo.clear, t.duration)),
            Ho
          );
      }
      (Wo.clear = function () {
      ...
      var qo = Wo,
        ...
        Go = Xo({
          ...
          methods: {
            ...
            onTouchEnd: function (t) {
              this.active &&
                (this.slots("default") || t.preventDefault(),
                (this.active = !1),
            ...
            genContent: function () {
              ...
              return this.loading
                ? t(vt, { class: Qo("loading-icon") })
                : i
                ? n || t(Ko, { class: Qo("delete-icon") })
                : e
                ? n || t(Uo, { class: Qo("collapse-icon") })
                : n;
            },
          },
          render: function () {
            var t = arguments[0];
            return t("div", { class: Qo("wrapper", { wider: this.wider }) }, [
              t(
                "div",
                {
                  attrs: { role: "button", tabindex: "0" },
        ...
        ea = Jo({
          ...
          methods: {
            ...
            onPress: function (t, e) {
              if ("" !== t) {
                ...
                "delete" === e
                  ? (this.$emit("delete"),
                    this.$emit("update:value", i.slice(0, i.length - 1)))
                  : "close" === e
                  ? this.onClose()
                  : i.length < this.maxlength &&
                    (this.$emit("input", t), this.$emit("update:value", i + t));
            ...
            genTitle: function () {
              var t = this.$createElement,
                ...
                s = n && "default" === i;
              if (e || s || r)
                return t("div", { class: ta("header") }, [
                  r && t("span", { class: ta("title-left") }, [r]),
                  e && t("h2", { class: ta("title") }, [e]),
                  s &&
                    t(
                      "button",
                      {
            ...
            genKeys: function () {
              ...
              return this.keys.map(function (i) {
                return e(
                  ...
                  [
                    "delete" === i.type && t.slots("delete"),
                    "extra" === i.type && t.slots("extra-key"),
                  ]
                );
              });
            },
          ...
          render: function () {
            ...
            return t(
              "transition",
              { attrs: { name: this.transition ? "van-slide-up" : "" } },
              [
                t(
                  "div",
                  {
                  ...
                  [
                    e,
                    t("div", { class: ta("body") }, [
                      t("div", { class: ta("keys") }, [this.genKeys()]),
                      this.genSidebar(),
                    ]),
                  ]
                ),
      ...
      var aa = na({
          ...
          computed: {
            ...
            pages: function () {
              ...
              s &&
                (r =
                  (n = Math.max(this.value - Math.floor(i / 2), 1)) + i - 1) >
                  e &&
                (n = (r = e) - i + 1);
              for (var o = n; o <= r; o++) {
          ...
          methods: {
            select: function (t, e) {
              (t = Math.min(this.count, Math.max(1, t))),
                this.value !== t &&
                  (this.$emit("input", t), e && this.$emit("change", t));
            },
          },
          render: function () {
            var t,
            ...
            return n("ul", { class: ra({ simple: s }) }, [
              n(
                ...
                [
                  (null != (t = this.slots("prev-text")) ? t : this.prevText) ||
                    sa("prev"),
                ]
              ),
              ...
              s &&
                n("li", { class: ra("page-desc") }, [
                  this.slots("pageDesc") || r + "/" + this.count,
                ]),
              n(
                "li",
                {
                  class: [
                    ra("item", { disabled: r === this.count }),
                    ra("next"),
                    Ot,
                  ],
                  on: { click: o(r + 1) },
                ...
                [
                  (null != (e = this.slots("next-text")) ? e : this.nextText) ||
                    sa("next"),
                ]
              ),
            ]);
              ...
              scopedSlots: {
                default: function () {
                  return [
                    ...
                    t("div", { class: ua("content") }, [
                      i.default && i.default(),
                    ]),
                    i.footer &&
                      t("div", { class: [ua("footer"), Tt] }, [i.footer()]),
                  ];
                },
              },
            },
      ...
      function va(t, e, i, n) {
        for (
          ...
          var g,
            ...
            S = u && v === a.length,
            k = void 0;
          0 !== v && c && (k = { marginLeft: Object(Y.a)(c) }),
            m.push(
              t(
                "li",
                {
                  class: [
                    ((g = {}), (g["van-hairline--left"] = y), g),
                    ma("item", { focus: S }),
                  ],
                  style: k,
                },
        ...
        return t("div", { class: ma() }, [
          ...
          p && t("div", { class: ma(f ? "error-info" : "info") }, [p]),
        ]);
      }
      va.props = {
        info: String,
      ...
      var ga = pa(va),
          ...
          methods: {
            ...
            updateLocation: function () {
              ...
              this.$nextTick(function () {
                t.value &&
                  (t.popper
                    ? t.popper.setOptions({ placement: t.placement })
            ...
            renderAction: function (t, e) {
              ...
              return n(
                ...
                [
                  r && n(st, { attrs: { name: r }, class: ka("action-icon") }),
            ...
            return t(
              ...
              [
                t(
                  ...
                  [
                    t("div", { class: ka("arrow") }),
                    t(
                      "div",
                      { class: ka("content"), attrs: { role: "menu" } },
                      [
                        this.slots("default") ||
        ...
        Ta = Ca({
          ...
          render: function () {
            ...
            return t("div", { class: Oa(), style: l }, [
              t("span", { class: Oa("portion"), style: a }, [
                r &&
                  t("span", { ref: "pivot", style: o, class: Oa("pivot") }, [
                    n,
                  ]),
              ]),
            ]);
        ...
        $a = Object(l.a)("pull-refresh"),
        Ba = $a[0],
        Ia = $a[1],
        Da = $a[2],
        Ea = ["pulling", "loosing", "success"],
        ja = Ba({
          mixins: [R],
          props: {
            disabled: Boolean,
          ...
          methods: {
            checkPullStart: function (t) {
              (this.ceiling = 0 === A(this.scrollEl)),
            ...
            onTouchMove: function (t) {
              this.touchable &&
                ...
                this.ceiling &&
                  this.deltaY >= 0 &&
                  "vertical" === this.direction &&
                  (k(t), this.setStatus(this.ease(this.deltaY))));
            },
            onTouchEnd: function () {
              var t = this;
              this.touchable &&
            ...
            genStatus: function () {
              ...
              return (
                -1 !== Ea.indexOf(e) &&
                  r.push(t("div", { class: Ia("text") }, [s])),
                "loading" === e &&
                  r.push(t(vt, { attrs: { size: "16" } }, [s])),
                r
              );
            },
          ...
          render: function () {
            ...
            return t("div", { class: Ia() }, [
              t("div", { ref: "track", class: Ia("track"), style: e }, [
                t("div", { class: Ia("head"), style: this.headStyle }, [
                  this.genStatus(),
                ]),
                this.slots(),
              ]),
      ...
      var Aa = La({
          ...
          computed: {
            list: function () {
              for (var t, e, i, n = [], r = 1; r <= this.count; r++)
                n.push(
                  ((t = this.value),
                  (e = r),
                  (i = this.allowHalf),
                  t >= e ? "full" : t + 0.5 >= e && i ? "half" : "void")
                );
              return n;
            },
          ...
          methods: {
                ...
                i.forEach(function (t, i) {
                  e.allowHalf
                    ? n.push(
                        ...
                        { score: i + 1, left: t.left + t.width / 2 }
                      )
            ...
            onTouchMove: function (t) {
              if (
                ...
                !this.disabled &&
                this.touchable &&
                (this.touchMove(t), "horizontal" === this.direction)
              ) {
                k(t);
                ...
                r(
                  ...
                  [
                    r(st, {
                      ...
                      class: Na("icon", { disabled: c, full: f }),
                      on: {
                        click: function () {
                          n.select(d);
                        },
                    ...
                    this.allowHalf &&
                      r(st, {
                        ...
                        class: Na("icon", ["half", { disabled: c, full: !p }]),
                        on: {
                          click: function () {
                            n.select(d - 0.5);
                          },
      ...
      function qa(t, e, i, r) {
        var o = {
            ...
            on: n({}, r.listeners, {
              keypress: function (t) {
                13 === t.keyCode && (k(t), d(r, "search", e.value)),
                  d(r, "keypress", t);
              },
            }),
          },
        ...
        return (
          ...
          t(
            ...
            [
              ...
              t("div", { class: _a("content", e.shape) }, [
                (function () {
                  if (i.label || e.label)
                    return t("div", { class: _a("label") }, [
        ...
        Za = Xa({
          ...
          methods: {
            ...
            genHeader: function () {
              ...
              if (e || i)
                return t("div", { class: Qa("header") }, [
                  e && t("h2", { class: Qa("title") }, [e]),
                  i && t("span", { class: Qa("description") }, [i]),
                ]);
            },
            genOptions: function (t, e) {
              var i = this,
                n = this.$createElement;
              return n("div", { class: Qa("options", { border: e }) }, [
                t.map(function (t, e) {
                  return n(
                    "div",
                    {
                    ...
                    [
                      ...
                      t.name && n("span", { class: Qa("name") }, [t.name]),
                      t.description &&
                        n("span", { class: Qa("option-description") }, [
                          t.description,
                        ]),
                    ]
                  );
            ...
            genCancelText: function () {
              var t,
                e = this.$createElement,
                i = null != (t = this.cancelText) ? t : Ga("cancel");
              if (i)
                return e(
                  "button",
                  {
      ...
      function ul(t, e, i, n) {
        ...
        return t(
          "div",
          s()([{ class: cl({ animate: e.animate, round: e.round }) }, h(n)]),
          [
            (function () {
              if (e.avatar) {
                var i = Object(Y.a)(e.avatarSize);
                return t("div", {
                  class: cl("avatar", e.avatarShape),
                  style: { width: i, height: i },
                });
              }
            })(),
            t("div", { class: cl("content") }, [
              (function () {
                if (e.title)
                  return t("h3", {
                    class: cl("title"),
                    style: { width: Object(Y.a)(e.titleWidth) },
                  });
              })(),
              (function () {
                for (var i, n = [], r = e.rowWidth, s = 0; s < e.row; s++)
                  n.push(
                    t("div", {
                      class: cl("row"),
                      style: {
      ...
      var hl = ll(ul),
        dl = { QUOTA_LIMIT: 0, STOCK_LIMIT: 1 },
        fl = { LIMIT_TYPE: dl, UNSELECTED_SKU_VALUE_ID: "" },
        pl = function (t) {
          var e = {};
          return (
            t.forEach(function (t) {
              ...
              t.tree.some(function (t) {
                ...
                if (r && t.v) {
                  var s =
                    ...
                    o = s.previewImgUrl || s.imgUrl || s.img_url;
        ...
        return t("div", s()([{ class: [Cl(), $t] }, h(r)]), [
          f &&
            t(
              ...
              [null == (o = i["sku-header-image-extra"]) ? void 0 : o.call(i)]
            ),
          t("div", { class: Cl("goods-info") }, [
            null == i.default ? void 0 : i.default(),
          ]),
        ]);
      }
      ...
      var Tl = wl(Ol),
        $l = Object(l.a)("sku-header-item"),
        Bl = $l[0],
        Il = $l[1];
      var Dl = Bl(function (t, e, i, n) {
          return t("div", s()([{ class: Il() }, h(n)]), [
            i.default && i.default(),
          ]);
        }),
        El = Object(l.a)("sku-row"),
        jl = El[0],
        Pl = El[1],
        Ll = El[2],
        Nl = jl({
          mixins: [
            ...
            W(function (t) {
              this.scrollable &&
                this.$refs.scroller &&
                t(this.$refs.scroller, "scroll", this.onScroll);
            }),
          ],
          props: { skuRow: Object },
          data: function () {
          ...
          methods: {
            ...
            genTitle: function () {
              var t = this.$createElement;
              return t("div", { class: Pl("title") }, [
                this.skuRow.k,
                this.skuRow.is_multiple &&
                  t("span", { class: Pl("title-multiple") }, [
                    "（",
                    Ll("multiple"),
                    "）",
                  ]),
            ...
            genIndicator: function () {
              ...
              if (this.scrollable) {
                ...
                return t("div", { class: Pl("indicator-wrapper") }, [
                  t("div", { class: Pl("indicator") }, [
                    t("div", { class: Pl("indicator-slider"), style: e }),
                  ]),
                ]);
              }
            },
            genContent: function () {
              ...
              if (this.skuRow.largeImageMode) {
                ...
                return (
                  ...
                  t("div", { class: Pl("scroller"), ref: "scroller" }, [
                    t("div", { class: Pl("row"), ref: "row" }, [i]),
                    n.length ? t("div", { class: Pl("row") }, [n]) : null,
                  ])
                );
              }
              return e;
            ...
            centerItem: function (t) {
              if (this.skuRow.largeImageMode && t) {
                ...
                if (r && s && o && o.$el) {
                  var a = o.$el,
                    l = a.offsetLeft - (r.offsetWidth - a.offsetWidth) / 2;
                  r.scrollLeft = l;
                }
              }
            },
        ...
        Al = (0, Object(l.a)("sku-row-item")[0])({
          ...
          computed: {
            ...
            choosable: function () {
              return (
                !this.disableSoldoutSku ||
                bl(this.skuList, this.selectedSku, {
                  key: this.skuKeyStr,
          ...
          methods: {
            onSelect: function () {
              this.choosable &&
                this.skuEventBus.$emit(
                  "sku:select",
                  n({}, this.skuValue, { skuKeyStr: this.skuKeyStr })
                );
            },
            onPreviewImg: function (t) {
              ...
              this.skuEventBus.$emit(
                "sku:previewImage",
                n({}, e, { ks: i, imgUrl: e.imgUrl || e.img_url })
              );
            },
            genImage: function (t) {
      ...
      var Hl = Fl({
          ...
          data: function () {
            var t,
              e = null != (t = this.value) ? t : this.defaultValue,
              i = this.format(e);
            return (
              Rl(i, this.value) || this.$emit("input", i), { currentValue: i }
            );
          },
          computed: {
            ...
            inputStyle: function () {
              var t = {};
              return (
                this.inputWidth && (t.width = Object(Y.a)(this.inputWidth)),
          ...
          methods: {
            ...
            format: function (t) {
              return (
                (this.allowEmpty && "" === t) ||
                  ((t = "" === (t = this.formatNumber(t)) ? 0 : +t),
                  (t = Object(Li.a)(t) ? this.min : t),
                  (t = Math.max(Math.min(this.max, t), this.min)),
                  Object(m.c)(this.decimalLength) &&
            ...
            onFocus: function (t) {
              this.disableInput && this.$refs.input
            ...
            onTouchEnd: function (t) {
              this.longPress &&
                (clearTimeout(this.longPressTimer), this.isLongPress && k(t));
            },
          ...
          render: function () {
            ...
            return e("div", { class: Vl([this.theme]) }, [
              e(
                "button",
                s()([
                  {
        ...
        Yl = Wl({
          ...
          computed: {
            stepperLimit: function () {
              ...
              return (
                this.quota > 0 && e <= this.stock
                  ? ((t = e < 0 ? 0 : e), (this.limitType = Kl))
                  : ((t = this.stock), (this.limitType = Ul)),
                t
              );
            },
            ...
            quotaText: function () {
              ...
              if (e) i = e;
                ...
                var n = [];
                this.startSaleNum > 1 &&
                  n.push(ql("quotaStart", this.startSaleNum)),
                  this.quota > 0 && n.push(ql("quotaLimit", this.quota)),
                  (i = n.join(ql("comma")));
              }
              return i;
            },
          ...
          render: function () {
            ...
            return e("div", { class: "van-sku-stepper-stock" }, [
              ...
              !this.hideQuotaText &&
                this.quotaText &&
                e("span", { class: "van-sku__stepper-quota" }, [
                  "(",
                  this.quotaText,
                  ")",
                ]),
      ...
      var ec = Object(l.a)("uploader"),
        ...
        rc = ic({
          ...
          methods: {
            ...
            readFile: function (t) {
              ...
              if (Array.isArray(t)) {
                ...
                Gl(t, this.resultType).then(function (n) {
            ...
            onAfterRead: function (t, e) {
              ...
              (Array.isArray(n) ? Boolean(n.length) : Boolean(n)) &&
                (this.$emit("input", [].concat(this.fileList, Ql(n))),
                this.afterRead && this.afterRead(n, this.getDetail()));
            },
            onDelete: function (t, e) {
              var i,
                n = this,
                r = null != (i = t.beforeDelete) ? i : this.beforeDelete;
              if (r) {
              ...
              if ("uploading" === i || "failed" === i) {
                var r =
                    "failed" === i
                      ...
                      : e(vt, { class: nc("loading") }),
                  s = Object(m.c)(n) && "" !== n;
                return e("div", { class: nc("mask") }, [
                  r,
                  s && e("div", { class: nc("mask-message") }, [n]),
                ]);
              }
            },
            genPreviewItem: function (t, e) {
              var i,
                ...
                f = null != (s = t.imageFit) ? s : this.imageFit,
                p = tc(t)
                  ? a(
                      sn,
                      {
                  ...
                  : a(
                      ...
                      [
                        ...
                        a("div", { class: [nc("file-name"), "van-ellipsis"] }, [
            ...
            genUpload: function () {
              ...
              if (!(this.fileList.length >= this.maxCount) && this.showUpload) {
                ...
                if (i)
                  return t(
                    "div",
                    { class: nc("input-wrapper"), key: "input-wrapper" },
                    [i, r]
                  );
                if (this.previewSize) {
                ...
                return t("div", { class: nc("upload"), style: e }, [
                  t(st, {
                    attrs: { name: this.uploadIcon },
                    class: nc("upload-icon"),
                  }),
                  this.uploadText &&
                    t("span", { class: nc("upload-text") }, [this.uploadText]),
                  r,
                ]);
              }
            },
          ...
          render: function () {
            var t = arguments[0];
            return t("div", { class: nc() }, [
              t("div", { class: nc("wrapper", { disabled: this.disabled }) }, [
                this.genPreviewList(),
                this.genUpload(),
              ]),
            ]);
        ...
        sc = Object(l.a)("sku-img-uploader"),
        oc = sc[0],
        ac = sc[2],
        lc = oc({
          props: {
      ...
      var cc = Object(l.a)("sku-datetime-field"),
        uc = cc[0],
        hc = cc[2],
        dc = uc({
          props: {
        ...
        gc = pc({
          ...
          methods: {
            ...
            getMessages: function () {
              var t = {};
              return (
                this.messageValues.forEach(function (e, i) {
              ...
              for (var t = this.messageValues, e = 0; e < t.length; e++) {
                ...
                if ("" === i) {
                  if ("1" === String(n.required))
                    return vc("image" === n.type ? "upload" : "fill") + n.name;
                } else {
                  if ("tel" === n.type && !Object(Li.b)(i))
                    return vc("invalid.tel");
                  if ("mobile" === n.type && !/^\d{6,20}$/.test(i))
                    return vc("invalid.mobile");
                  if ("email" === n.type && !Xl(i)) return vc("invalid.email");
                  if ("id_no" === n.type && (i.length < 15 || i.length > 18))
                    return vc("invalid.id_no");
                }
              }
            },
            getFormatter: function (t) {
              return function (e) {
                return "mobile" === t.type || "tel" === t.type
                  ? e.replace(/[^\d.]/g, "")
                  : e;
              };
            },
              ...
              return "image" === t.type
                ? n(
                    ...
                    [
                      ...
                      n("div", { class: mc("image-cell-label") }, [
                        vc("imageLabel"),
                      ]),
                    ]
                  )
                : ["date", "time"].indexOf(t.type) > -1
                ? n(dc, {
                    attrs: {
                      label: t.name,
                      required: "1" === String(t.required),
          ...
          render: function () {
            var t = arguments[0];
            return t("div", { class: mc() }, [
              this.messages.map(this.genMessage),
            ]);
          },
        }),
        bc = Object(l.a)("sku-actions"),
        yc = bc[0],
        Sc = bc[1],
        kc = bc[2];
      function xc(t, e, i, n) {
        ...
        Ic = Oc({
          ...
          computed: {
            ...
            isSkuCombSelected: function () {
              var t = this;
              return (
                !(this.hasSku && !ml(this.skuTree, this.selectedSku)) &&
                !this.propList
                  .filter(function (t) {
            ...
            selectedSkuComb: function () {
              ...
              return (
                this.isSkuCombSelected &&
                  (t = this.hasSku
                    ? vl(this.skuList, this.selectedSku)
                    : {
                        id: this.sku.collection_id,
                        price: Math.round(100 * this.sku.price),
                        stock_num: this.sku.stock_num,
                      }) &&
                  ((t.properties = Sl(this.propList, this.selectedProp)),
                  (t.property_price = this.selectedPropValues.reduce(function (
                    t,
                    e
                  ) {
                    return t + (e.price || 0);
          ...
          methods: {
            ...
            resetSelectedSku: function () {
              ...
              (this.selectedSku = {}),
                ...
                this.skuTree.forEach(function (e) {
                  ...
                  n &&
                    bl(t.skuList, t.selectedSku, { key: i, valueId: n }) &&
                    (t.selectedSku[i] = n);
                });
              ...
              this.propList.forEach(function (e) {
                ...
                Object(m.d)(this.selectedProp) &&
                  this.propList.forEach(function (e) {
                    var i;
                    if (
                      (null == e || null == (i = e.v) ? void 0 : i.length) > 0
                    ) {
                      var n = e.v,
                        r = e.k_id;
                      n.some(function (t) {
            ...
            onSelect: function (t) {
              ...
              (this.selectedSku =
                this.selectedSku[t.skuKeyStr] === t.id
                  ? n({}, this.selectedSku, (((e = {})[t.skuKeyStr] = ""), e))
                  : n(
                      {},
                      this.selectedSku,
            ...
            onPreviewImage: function (t) {
              ...
              t &&
                t.imgUrl &&
                (this.imageList.some(function (e, i) {
            ...
            onOverLimit: function (t) {
              ...
              s
                ...
                : "minus" === e
                ? this.startSaleNum > 1
                  ? xe($c("minusStartTip", this.startSaleNum))
                  : xe($c("minusTip"))
                : "plus" === e &&
                  xe(
                    i === Bc
          ...
          render: function () {
            ...
            if (!this.isSkuEmpty) {
              var i = this.sku,
                ...
                b =
                  ...
                  e(
                    ...
                    [
                      e("template", { slot: "sku-header-image-extra" }, [
                        g("sku-header-image-extra"),
                      ]),
                      g("sku-header-price") ||
                        e("div", { class: "van-sku__goods-price" }, [
                          e("span", { class: "van-sku__price-symbol" }, ["￥"]),
                          e("span", { class: "van-sku__price-num" }, [s]),
                          this.priceTag &&
                            e("span", { class: "van-sku__price-tag" }, [
                              this.priceTag,
                            ]),
                        ]),
                      g("sku-header-origin-price") ||
                        (a && e(Dl, [$c("originPrice"), " ￥", a])),
                      !this.hideStock &&
                        e(Dl, [
                          e("span", { class: "van-sku__stock" }, [
                            this.stockText,
                          ]),
                        ]),
                      this.hasSkuOrAttr &&
                        !this.hideSelectedText &&
                        e(Dl, [this.selectedText]),
                      g("sku-header-extra"),
                    ]
                  ),
                y =
                  g("sku-group") ||
                  (this.hasSkuOrAttr &&
                    e("div", { class: this.skuGroupClass }, [
              ...
              return e(
                ...
                [
                  b,
                  e("div", { class: "van-sku-body", style: this.bodyStyle }, [
                    g("sku-body-top"),
                    y,
                    g("extra-sku-group"),
                    S,
      ...
      Bo.a.add({
        ...
        (Ic.SkuRow = Nl),
        (Ic.SkuRowItem = Al),
        (Ic.SkuRowPropItem = Ml),
        (Ic.skuHelper = kl),
        (Ic.skuConstants = fl);
      var Dc = Ic,
        Ec = Object(l.a)("slider"),
        jc = Ec[0],
        Pc = Ec[1],
        Lc = function (t, e) {
        ...
        Nc = jc({
          ...
          methods: {
            ...
            onTouchMove: function (t) {
              if (!this.disabled) {
                ...
                var e = this.$el.getBoundingClientRect(),
                  i =
                    ((this.vertical ? this.deltaY : this.deltaX) /
                      (this.vertical ? e.height : e.width)) *
                    this.scope;
                this.range
                  ? (this.currentValue[this.index] =
                      this.startValue[this.index] + i)
                  : (this.currentValue = this.startValue + i),
            ...
            updateValue: function (t, e) {
              (t = this.range
                ? this.handleOverlap(t).map(this.format)
                : this.format(t)),
                Lc(t, this.value) || this.$emit("input", t),
                e && !Lc(t, this.startValue) && this.$emit("change", t);
            },
            format: function (t) {
              return (
                Math.round(
                  Math.max(this.min, Math.min(t, this.max)) / this.step
                ) * this.step
              );
            },
          },
          render: function () {
            var t,
              ...
              o = r ? "width" : "height",
              a =
                (((t = { background: this.inactiveColor })[o] = Object(Y.a)(
                  this.barHeight
                )),
                t),
              l = function () {
            ...
            var h = function (t) {
              ...
              return n(
                ...
                [
                  i.slots("button") ||
                    n("div", { class: Pc("button"), style: i.buttonStyle }),
                ]
              );
            };
            return n(
        ...
        Fc = Mc({
          ...
          render: function () {
            var t,
              ...
              i = this.status,
              n = this.active,
              r = this.parent.direction;
            return e(
              "div",
              { class: [Ot, zc([r, ((t = {}), (t[i] = i), t)])] },
              [
                e(
                  "div",
                  {
                ...
                e("div", { class: zc("line"), style: this.lineStyle }),
              ]
            );
          },
        }),
        ...
        _c = Rc({
          ...
          render: function () {
            var t = arguments[0];
            return t("div", { class: Hc([this.direction]) }, [
              t("div", { class: Hc("items") }, [this.slots()]),
            ]);
          },
        }),
        Wc = Object(l.a)("submit-bar"),
        qc = Wc[0],
        Kc = Wc[1],
        Uc = Wc[2];
      function Yc(t, e, i, n) {
        ...
        return t(
          "div",
          s()([{ class: Kc({ unfit: !e.safeAreaInsetBottom }) }, h(n)]),
          [
            i.top && i.top(),
            (function () {
              if (i.tip || r)
                return t("div", { class: Kc("tip") }, [
                  a && t(st, { class: Kc("tip-icon"), attrs: { name: a } }),
                  r && t("span", { class: Kc("tip-text") }, [r]),
                  i.tip && i.tip(),
                ]);
            })(),
            t("div", { class: Kc("bar") }, [
              ...
              (function () {
                if ("number" == typeof o) {
                  ...
                  return t(
                    ...
                    [
                      t("span", [e.label || Uc("label")]),
                      t("span", { class: Kc("price") }, [
                        e.currency,
                        t("span", { class: Kc("price", "integer") }, [i[0]]),
                        n,
                      ]),
                      e.suffixLabel &&
                        t("span", { class: Kc("suffix-label") }, [
                          e.suffixLabel,
                        ]),
                    ]
                  );
      ...
      var Xc = qc(Yc),
        ...
        Jc = Gc({
          ...
          methods: {
            ...
            close: function (t) {
              (this.offset = 0),
                this.opened &&
                  ((this.opened = !1),
                  this.$emit("close", { position: t, name: this.name }));
            },
            onTouchStart: function (t) {
              this.disabled ||
                ((this.startOffset = this.offset), this.touchStart(t));
            },
            onTouchMove: function (t) {
              this.disabled ||
                (this.touchMove(t),
              ...
              void 0 === t && (t = "outside"),
                ...
                this.opened &&
                  ...
                  (this.beforeClose
                    ...
                    : this.onClose
                    ? this.onClose(t, this, { name: this.name })
                    : this.close(t));
            },
          ...
          render: function () {
            ...
            return t(
              "div",
              { class: Zc(), on: { click: this.getClickHandler("cell") } },
              [
                t("div", { class: Zc("wrapper"), style: e }, [
                  this.genLeftPart(),
                  this.slots(),
                  this.genRightPart(),
                ]),
      ...
      function nu(t, e, i, r) {
        return t(
          ...
          [t(ri, { props: n({}, e), on: n({}, r.listeners) })]
        );
      }
      nu.props = n({}, Je, {
        title: String,
            ...
            genTabbar: function () {
              ...
              return (0, this.$createElement)(
                "div",
                {
                  ...
                  style: { zIndex: this.zIndex },
                  class: [
                    ((t = {}), (t[Bt] = this.border), t),
                    au({ unfit: !this.fit, fixed: this.fixed }),
                  ],
                },
                [this.slots()]
              );
          ...
          render: function () {
            ...
            return e(
              ...
              [
                ...
                e("div", { class: hu("text") }, [
                  this.slots("default", { active: i }),
                ]),
              ]
            );
          },
        }),
        fu = Object(l.a)("tree-select"),
        pu = fu[0],
        mu = fu[1];
      function vu(t, e, i, n) {
        var r = e.items,
        ...
        return t(
          "div",
          s()([{ class: mu(), style: { height: Object(Y.a)(o) } }, h(n)]),
          [
            t(
              il,
              {
                ...
                : u.map(function (i) {
                    return t(
                      "div",
                      {
                        ...
                        class: [
                          "van-ellipsis",
                          mu("item", { active: p(i.id), disabled: i.disabled }),
                        ],
                        on: {
                          click: function () {
                            if (!i.disabled) {
                      ...
                      [
                        i.text,
                        p(i.id) &&
                          t(st, { attrs: { name: l }, class: mu("selected") }),
                      ]
                    );
                  }),
            ]),
